...
public class SQLFunctions {
     ...
     */
    public int getInteger(String table, String column, String identifier, Object value) {
        try {
     ...
     */
    public double getDouble(String table, String column, String identifier, Object value) {
        try {
            ResultSet resultSet = mySQLAPI.getConnection().prepareStatement
                    ("SELECT * FROM " + table + " WHERE " + identifier + " = '" + value + "'").executeQuery();
     ...
     */
    public String getString(String table, String column, String identifier, Object value) {
        try {
            ResultSet resultSet = mySQLAPI.getConnection().prepareStatement
                    ("SELECT * FROM " + table + " WHERE " + identifier + " = '" + value + "'").executeQuery();
     ...
     */
    public boolean getBoolean(String table, String column, String identifier, Object value) {
        try {
            ResultSet resultSet = mySQLAPI.getConnection().prepareStatement
                    ("SELECT * FROM " + table + " WHERE " + identifier + " = '" + value + "'").executeQuery();
     ...
     */
    public Long getLong(String table, String column, String identifier, Object value) {
        try {
            ResultSet resultSet = mySQLAPI.getConnection().prepareStatement
                    ("SELECT * FROM " + table + " WHERE " + identifier + " = '" + value + "'").executeQuery();
     ...
     */
    public Float getFloat(String table, String column, String identifier, Object value) {
        try {
            ResultSet resultSet = mySQLAPI.getConnection().prepareStatement
                    ("SELECT * FROM " + table + " WHERE " + identifier + " = '" + value + "'").executeQuery();
     ...
     */
    public List<String> getList(String table, String column, String identifier, Object value) {
     ...
     *
     * @param mySQLAPI Database to set
     */
